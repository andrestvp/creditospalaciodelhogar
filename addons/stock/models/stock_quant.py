...
class StockQuant(models.Model):
    ...
    def _get_quants_action(self, domain=None, extend=False):
        ...
        action = {
            ...
            'domain': domain or [],
            'help': """
                <p class="o_view_nocontent_empty_folder">No hay Stock disponible</p>
                <p>Este análisis le brinda una descripción general del nivel actual de 
                  existencias de sus productos.</p>
                """
        }
