    ...
    def check(self, model, mode='read', raise_exception=True):
        ...
        if not r and raise_exception:
            ...
            msg_heads = {
                ...
                'read': _("Usted no tiene permiso para realizar esta acción."),
                'write':  _("Usted no tiene permiso para realizar esta acción."),
                'create': _("Usted no tiene permiso para realizar esta acción."),
                'unlink': _("Usted no tiene permiso para realizar esta acción."),
            }
            ...
            resolution_info = _("Cualquier inconveniente por favor comunicarse con el Administrador si es necesario.")
